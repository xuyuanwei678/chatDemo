...
(function() {
    "use strict";
    var $, Animation, Draggable, Gridly, enable,
    ...
    Gridly = (function() {
        ...
        Gridly.gridly = function($el, options) {
            ...
            if (!data) {
                ...
                // // 由于需要重置 但是这里重新传过来的 setting 并没有赋值给 data 导致元素位置不会发生变化。 故这里给data 重新赋值
                // data.settings.base = options.base
                // data.settings.gutter = options.gutter
                // data.settings.columns = options.columns
                //
                // setTimeout(function () {
                //     data.layout()
                //     // 由于调用的地方设置的动画为0.3s 这里 使用300 mm ， 否则动画就会停止
                // }, 300)
            }
        ...
        Gridly.prototype.changeEnable = function (arr) {
            enable = arr[0]
        }
